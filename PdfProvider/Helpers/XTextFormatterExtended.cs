...
namespace PdfProvider.Helpers
{
    ...
    /// </summary>
    public class XTextFormatterExtended
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XTextFormatter"/> class.
        /// </summary>
        public XTextFormatterExtended(XGraphics gfx)
        {
            if (gfx == null)
        ...
        public void PrepareDrawString(string text, XFont font, XRect layoutRectangle, out int lastFittingChar, out double neededHeight)
        {
            ...
            for (int idx = 0; idx < count; idx++)
            {
                ...
                neededHeight = dy + block.Location.Y; //Performance optimization?
            }
        }
